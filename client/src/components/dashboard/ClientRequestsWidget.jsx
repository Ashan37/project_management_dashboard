  ...
  return (
    <div className="p-6 bg-white shadow rounded-xl">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between">
          <span className="text-gray-600">👁️ Reviewed</span>
        ...
        <div className="flex justify-between">
          <span className="text-gray-600">✔️ Implemented</span>
          <span className="font-semibold text-purple-600">{stats.implemented}</span>
        </div>
        <div className="flex justify-between">
